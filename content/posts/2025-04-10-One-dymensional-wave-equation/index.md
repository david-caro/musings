...
$$
\mu dx\frac{d^2y}{dt^2} = T\sin{\left(\theta + d\theta\right)} - T\sin{\theta}
$$
...
$$
\mu dx\frac{d^2y}{dt^2} = T\sin{\theta} + T\cos{\theta}d\theta - T\sin{\theta} = T\cos{\theta}d\theta
$$

Rearranging a bit:

$$
\frac{d^2y}{dt^2} = \frac{T}{\mu}\cos{\theta}\frac{d\theta}{dx}
$$

For small $\theta$ approximation, we have $\cos{\theta} \approxeq 1$:

$$
\frac{d^2y}{dt^2} = \frac{T}{\mu}\frac{d\theta}{dx}
$$
...
$$
\frac{d^2y}{dt^2} = \frac{T}{\mu}\frac{d^2y}{dx^2} \equiv c^2\frac{d^2y}{dx^2}
$$
